...
// this is the  code for dynamic change 4/29/2025
...
function Dashboard() {
  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      try {
        ...
        // Calculate specialization count for bar chart
        ...
        setDepartmentCount(specializationCount);
      } catch (error) {
        console.error("Error fetching doctors:", error);
      }
    };
  ...
  const barData = {
    ...
    datasets: [
      {
        label: "Number of Doctors by Specialization",
  ...
  const pieData = {
    labels: ["Cardiology", "Dermatology", "Neurology"],
    datasets: [
      {
        data: [120, 90, 60],
        backgroundColor: ["#FF6384", "#36A2EB", "#FFCE56"],
  ...
  // Line Chart (static revenue example)
  const lineData = {
    ...
    datasets: [
      {
        ...
        fill: true,
        backgroundColor: "rgba(118, 45, 229, 0.2)",
        borderColor: "#762de5",
      },
    ],
  };
  ...
  return (
    <div style={{ backgroundColor: "#f4f6f9", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          <h1 style={{ fontSize: "40px", marginBottom: "10px", color: "#762de5" }}>
            {doctors.length}
          </h1>
          <p style={{ fontSize: "18px", color: "#666" }}>Total Doctors</p>
        </div>
      </div>
      ...
      >
        ...
        >
          <h3 style={{ marginBottom: "15px" }}>Doctors by Department</h3>
          <Bar data={barData} />
        </div>
        <div
          style={{
        ...
        >
          <h3 style={{ marginBottom: "15px" }}>Revenue Growth</h3>
          <Line data={lineData} />
        </div>
      </div>
      ...
      {/* Doctors Table */}
      <div style={{ padding: "20px" }}>
        <h2 style={{ marginBottom: "20px", textAlign: "center" }}>Doctor List</h2>
        {doctors.length > 0 ? (
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", backgroundColor: "#fff", borderRadius: "12px", boxShadow: "0 4px 8px rgba(0,0,0,0.1)" }}>
              <thead style={{ backgroundColor: "#762de5", color: "#fff" }}>
                <tr>
